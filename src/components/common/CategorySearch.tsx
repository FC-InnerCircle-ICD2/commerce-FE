...
export default function CategorySearch() {
  ...
  return (
    <div className="grow max-w-[550] text-sm h-[50] pr-2 py-1 bg-headerMain rounded-lg hidden items-center mobile:flex">
      ...
      />
      <div className="bg-white rounded-lg w-[40] h-[40] shadow-md flex items-center justify-center">
