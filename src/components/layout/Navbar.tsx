        ...
        <div className='flex items-center justify-between h-12'>
          <div className='flex items-center space-x-4'>
              <span className="flex items-center gap-2">
                <Image src="/paw.svg" alt='서브 로고 이미지' width={10} height={10} />
                <span className="text-xs text-[#A8C4D9]">감성개발자들</span>
              </span>
              <span className="flex items-center gap-2">
              <Image src="/cent.svg" alt='서브 로고 이미지2' width={10} height={10} />
              <span className="text-xs text-neutral-400">Inner Circle</span>
              </span>
          </div>
          <div className='text-xs flex items-center gap-4'>
            <span className="flex items-center gap-2">
            <Image src="/profile.svg" alt='프로필 이미지' width={12} height={12} />
            <span>홍길동 님</span>
            </span>
            <Link
              href=''
